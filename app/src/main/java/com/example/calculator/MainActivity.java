...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public Button red,blue,italic,big,small,moren;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moren=(Button)findViewById(R.id.DEFAULT);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_clr:
                ...
                et_input.setText("");
                break;
            case R.id.btn_del: //判断是否为空，然后进行删除
                if(clr_flag){
                    clr_flag=false;
                    str="";
                    et_input.setText("");
            ...
            case R.id.Blue:
                et_input.setTextColor(Color.BLUE);
                break;
            case R.id.Red:
                et_input.setTextColor(Color.RED);
                break;
            case R.id.italic:
                et_input.setTypeface(Typeface.MONOSPACE,Typeface.ITALIC);
            case R.id.BIG:
                et_input.setTextSize(TypedValue.COMPLEX_UNIT_PX,100);
                break;
            case R.id.SMALL:
                et_input.setTextSize(TypedValue.COMPLEX_UNIT_PX,60);
                break;
            case R.id.DEFAULT:
                et_input.setTypeface(Typeface.MONOSPACE,Typeface.NORMAL);
                et_input.setTextColor(Color.BLACK);
                et_input.setTextSize(TypedValue.COMPLEX_UNIT_PX,80);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.Red:
                ...
                break;
            case R.id.Blue:
                et_input.setBackgroundColor(Color.BLUE);
                break;
            case R.id.White:
